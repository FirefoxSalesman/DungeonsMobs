...
public class ModStructureModifiers {
	...
	private static final DeferredRegister<Codec<? extends StructureModifier>> STRUCTURE_MODIFIER_SERIALIZERS = DeferredRegister
			.create(ForgeRegistries.Keys.STRUCTURE_MODIFIER_SERIALIZERS, DungeonsMobs.MOD_ID);

	/**
	 * Stock structure modifier for adding mob spawns to structures.
	 */
	public static final RegistryObject<Codec<DungeonsMobsStructureModifiers.AddSpawnsStructureModifier>> ADD_SPAWNS_STRUCTURE_MODIFIER_TYPE = STRUCTURE_MODIFIER_SERIALIZERS
			.register("add_spawns", () -> RecordCodecBuilder.create(builder -> builder.group(
					...
					// parse.
					new ExtraCodecs.EitherCodec<>(MobSpawnSettings.SpawnerData.CODEC.listOf(),
	 ...
	 */
	public static final RegistryObject<Codec<DungeonsMobsStructureModifiers.RemoveSpawnsStructureModifier>> REMOVE_SPAWNS_STRUCTURE_MODIFIER_TYPE = STRUCTURE_MODIFIER_SERIALIZERS
			.register("remove_spawns", () -> RecordCodecBuilder.create(builder -> builder.group(
					LIST_CODEC.fieldOf("structures").forGetter(
							DungeonsMobsStructureModifiers.RemoveSpawnsStructureModifier::structures),
					RegistryCodecs.homogeneousList(ForgeRegistries.Keys.ENTITY_TYPES)
