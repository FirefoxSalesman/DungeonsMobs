...
public class Combo implements INBTSerializable<CompoundTag> {
	...
	public CompoundTag serializeNBT() {
		...
		tag.put("lastExplorerCheckpoint", this.newDoubleNBTList(lastExplorerCheckpoint.getX(),
				lastExplorerCheckpoint.getY(), lastExplorerCheckpoint.getZ()));

		BlockPos lastLuckyExplorerCheckpoint = this.getLastLuckyExplorerCheckpoint();
		tag.put("lastLuckyExplorerCheckpoint", this.newDoubleNBTList(lastLuckyExplorerCheckpoint.getX(),
				lastLuckyExplorerCheckpoint.getY(), lastLuckyExplorerCheckpoint.getZ()));
	...
	public void deserializeNBT(CompoundTag tag) {
		...
		BlockPos lastExplorerCheckpoint = new BlockPos(listnbt.getInt(0), listnbt.getInt(1),
				listnbt.getInt(2));
		this.setLastExplorerCheckpoint(lastExplorerCheckpoint);

		ListTag listnbt1 = tag.getList("lastLuckyExplorerCheckpoint", 6);
		BlockPos lastLuckyExplorerCheckpoint = new BlockPos(listnbt1.getInt(0), listnbt1.getInt(1),
				listnbt1.getInt(2));
