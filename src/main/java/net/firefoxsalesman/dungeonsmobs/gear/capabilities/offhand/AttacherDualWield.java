...
public class AttacherDualWield {
	...
	private static class DualWieldProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
		...
		public static final ResourceLocation IDENTIFIER = new ResourceLocation(DungeonsMobs.MOD_ID,
				"dual_wield");
		...
		public <T> @NotNull LazyOptional<T> getCapability(@NotNull Capability<T> cap, Direction side) {
			return GearCapabilities.DUAL_WIELD_CAPABILITY.orEmpty(cap, this.optionalData);
		}
