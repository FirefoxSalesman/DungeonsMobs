...
public class AOECloudHelper {
	...
	public static void spawnExplosionCloudAtPos(LivingEntity attacker, boolean arrow, BlockPos blockPos,
			float radius) {
		int inGroundMitigator = arrow ? 1 : 0;
		AreaEffectCloud areaeffectcloudentity = new AreaEffectCloud(attacker.level(), blockPos.getX(),
	...
	public static void spawnRegenCloud(LivingEntity attacker, int amplifier) {
		AreaEffectCloud areaeffectcloudentity = new AreaEffectCloud(attacker.level(), attacker.getX(),
	...
	public static void spawnRegenCloudAtPos(LivingEntity attacker, boolean arrow, BlockPos blockPos,
			int amplifier) {
		int inGroundMitigator = arrow ? 1 : 0;
		AreaEffectCloud areaeffectcloudentity = new AreaEffectCloud(attacker.level(), blockPos.getX(),
				blockPos.getY() + inGroundMitigator, blockPos.getZ());
	...
	// public static void spawnSoulProtectionCloudAtPos(LivingEntity attacker,
	// BlockPos blockPos, int duration) {
	// AreaEffectCloud areaeffectcloudentity = new AreaEffectCloud(attacker.level(),
	// blockPos.getX(),
	...
	// MobEffectInstance shielding = new
	// MobEffectInstance(MobEffectInit.SOUL_PROTECTION.get(), duration);
	...
	public static void spawnPoisonCloudAtPos(LivingEntity attacker, boolean arrow, BlockPos blockPos,
			int amplifier) {
		int inGroundMitigator = arrow ? 1 : 0;
		AreaEffectCloud areaeffectcloudentity = new AreaEffectCloud(attacker.level(), blockPos.getX(),
				blockPos.getY() + inGroundMitigator, blockPos.getZ());
