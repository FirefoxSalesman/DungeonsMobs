...
public class ShearsGear extends MeleeGear {
	...
	@Override
	public boolean mineBlock(ItemStack p_179218_1_, Level p_179218_2_, BlockState p_179218_3_, BlockPos p_179218_4_,
			LivingEntity p_179218_5_) {
		if (!p_179218_2_.isClientSide && !ForgeRegistries.BLOCKS.tags().getTag(BlockTags.FIRE)
				.contains(p_179218_3_.getBlock())) {
			p_179218_1_.hurtAndBreak(1, p_179218_5_, (p_220036_0_) -> {
				p_220036_0_.broadcastBreakEvent(EquipmentSlot.MAINHAND);
			});
		}

		return p_179218_3_.is(BlockTags.LEAVES) || p_179218_3_.is(Blocks.COBWEB) || p_179218_3_.is(Blocks.GRASS)
				|| p_179218_3_.is(Blocks.FERN) || p_179218_3_.is(Blocks.DEAD_BUSH)
				|| p_179218_3_.is(Blocks.VINE) || p_179218_3_.is(Blocks.TRIPWIRE)
				|| p_179218_3_.is(BlockTags.WOOL)
				|| super.mineBlock(p_179218_1_, p_179218_2_, p_179218_3_, p_179218_4_, p_179218_5_);
	}

	@Override
	public boolean isCorrectToolForDrops(BlockState p_150897_1_) {
		return p_150897_1_.is(Blocks.COBWEB) || p_150897_1_.is(Blocks.REDSTONE_WIRE)
				|| p_150897_1_.is(Blocks.TRIPWIRE);
	}
	...
	public net.minecraft.world.InteractionResult interactLivingEntity(ItemStack stack,
		...
		if (entity instanceof net.minecraftforge.common.IForgeShearable) {
			...
			if (target.isShearable(stack, entity.level(), pos)) {
				...
				drops.forEach(d -> {
					net.minecraft.world.entity.item.ItemEntity ent = entity.spawnAtLocation(d,
							1.0F);
		...
		if (block instanceof GrowingPlantHeadBlock) {
			...
			if (!growingplantheadblock.isMaxAge(blockstate)) {
				...
				if (player instanceof ServerPlayer) {
					CriteriaTriggers.ITEM_USED_ON_BLOCK.trigger((ServerPlayer) player, blockpos,
							itemstack);
				}

				level.playSound(player, blockpos, SoundEvents.GROWING_PLANT_CROP, SoundSource.BLOCKS,
						1.0F, 1.0F);
