package net.firefoxsalesman.dungeonsmobs.gear.client.renderer.projectiles;
...
public class SoulWizardOrbRenderer extends ProjectileRenderer<SoulWizardOrbEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SoulWizardOrbEntity animatable, BakedGeoModel model,
	...
	@Override
	public void render(SoulWizardOrbEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn,
	...
	@Override
	public RenderType getRenderType(SoulWizardOrbEntity animatable, ResourceLocation texture,
