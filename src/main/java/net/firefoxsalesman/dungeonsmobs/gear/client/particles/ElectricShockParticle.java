package net.firefoxsalesman.dungeonsmobs.gear.client.particles;
...
public class ElectricShockParticle extends TextureSheetParticle {
	...
	private ElectricShockParticle(ClientLevel clientWorld, double xCoordIn, double yCoordIn, double zCoordIn,
	...
	public float getQuadSize(float scaleFactor) {
		return this.quadSize * Mth.clamp(((float) this.age + scaleFactor) / (float) this.lifetime * 32.0F, 0.0F,
				1.0F);
	}
	...
	public static class Factory implements ParticleProvider<SimpleParticleType> {
		...
		@Nullable
		@Override
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y,
				double z, double xSpeed, double ySpeed, double zSpeed) {
			ElectricShockParticle shockParticle = new ElectricShockParticle(worldIn, x, y, z, xSpeed,
					ySpeed, zSpeed);
