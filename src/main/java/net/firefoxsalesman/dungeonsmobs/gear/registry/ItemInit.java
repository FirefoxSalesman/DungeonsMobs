...
public class ItemInit {
	...
	public static final RegistryObject<Item> HARP_CROSSBOW = registerRangedWeapon("harp_crossbow",
			crossbowSupplier);
	public static final RegistryObject<Item> LIGHTNING_HARP_CROSSBOW = registerRangedWeapon(
			"lightning_harp_crossbow", crossbowSupplier);
	...
	// public static final RegistryObject<Item> ENCHANTED_GRASS =
	// registerArtifact("enchanted_grass",
	...
	public static final ArmorSetInit DARK_ARMOR = registerArmorSet("dark");
	public static final ArmorSetInit TITANS_SHROUD = registerArmorSet("titans_shroud");
