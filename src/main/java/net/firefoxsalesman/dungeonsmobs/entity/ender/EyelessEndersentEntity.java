...
public class EyelessEndersentEntity extends AbstractEndersentEntity {

	public EyelessEndersentEntity(EntityType<? extends AbstractEndersentEntity> type, Level level) {
		super(type, level);
	}
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(2, new AbstractEndersentEntity.AttackGoal(EyelessEndersentEntity.this, 1.0D));
